    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*createdContacts*/ 32) && t0_value !== (t0_value = /*index*/ ctx[15] + "")) set_data_dev(t0, t0_value);
